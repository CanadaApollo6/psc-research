...
The latest [GSE84161 investigation](reports/gse84161-study-investigation.md) links the five-donor monocyte study to Senger et al. (2017), verifies all **30 original CEL arrays**, and prepares a separate analysis across seven contrasts. It identifies unresolved donor correspondence, exact compound names, an approximately threefold paper/GEO concentration discrepancy and historical probe-mapping differences. The [array framework](docs/gse84161-array-protocol.md) specifies fresh normalization and fixed probe aggregation before program effects. No new program scores have been calculated; [specific source questions](docs/gse84161-source-questions.md) are prepared and unsent.
