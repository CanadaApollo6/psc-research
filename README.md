...
| **BACH2 genotype** | The [single C0/C1 RNA protocol](docs/psc-bach2-naive-rna-protocol.md) was frozen in pushed `a1b0a6e` before extraction. One endpoint, full independent audit and scientific replay are complete; complete aggregate reporting is next. Eight male PSC donors, not 16,659 cell replicates. No count-likelihood certificate, protein/translation claim or independent biological validation. |
...
The [active agenda](docs/psc-analysis-agenda.md), [roadmap](ROADMAP.md) and [final reserve appraisal](reports/psc-remaining-frontier-appraisal.md) define a finite stopping boundary. GSE255234 heme/LPS and GSE303012 H69 are PARKED for limited incremental discrimination, not an invented access failure. Finish reporting the two admitted endpoints and close this computational phase; no null result triggers a rescue sweep. Earlier scientific results remain below. No researcher contact, service enrollment, paid compute or clinical recommendation occurred.
