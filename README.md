...
The latest [independent-validation preparation](reports/ets2-validation-readiness.md) identifies a five-donor primary-human MEK-inhibitor study and a four-donor LPS/heme study, while preserving their assay and metadata gaps. The latter's 16 samples and 12 planned donor pairs are pinned. An amended prospective protocol uses control-only expression matching and keeps direct ETS2 perturbation, MEK response, generic stimulation and source reuse distinct. No new dataset scores have been calculated, and no fully eligible independent primary-human direct-ETS2 experiment was found in this finite search. A [focused author email](docs/ets2-lee-request-draft.md) and [reproducibility brief](docs/ets2-lee-reproducibility-brief.md) are drafted and unsent.
