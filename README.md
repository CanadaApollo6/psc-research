...
The [four-direction computational roadmap](docs/computational-followup-roadmap.md) records original UBASH3A RNA reads, the alternative-ending sequence, public peptide evidence and PRKD2 genetic-signal analysis. The bounded read audit, conditional sequence reconstruction and first public-protein search are complete; PRKD2 is next. These are tracked separately from the unperformed laboratory proposal.
