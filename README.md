...
The latest [GSE84161 normalization and mapping](reports/gse84161-normalization-and-mapping.md) processes all **30 original arrays**, preserving **54,675 probe sets** and aggregating **20,486 Entrez genes**. The primary ETS2 program maps **801/927 genes (86.4%)**, with 652 remaining after comparator-overlap removal. Eight of nine programs pass mapping gates; the gRNA1-up companion fails at 77.5%. Independent checks match every gene median exactly, and all 144 tests pass. No program scores or treatment contrasts have been calculated. The [study investigation](reports/gse84161-study-investigation.md) still leaves donor correspondence, compound identities and paper/GEO dose differences unresolved; [source questions](docs/gse84161-source-questions.md) remain unsent.
